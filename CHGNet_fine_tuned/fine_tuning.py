...
base_path="/data01/tian_02/ML/LGPS_fine_tuning"
dft_path = "/data01/tian_02/ML/LGPS_fine_tuning/dft_data"

folder_names = os.listdir(os.path.join(dft_path))
chgnet = CHGNet.load()

dataset_dict = {}
for folder in folder_names:
    dataset_dict_temp = parse_vasp_dir(
    file_root=os.path.join(dft_path, folder),
    check_electronic_convergence=False
)
